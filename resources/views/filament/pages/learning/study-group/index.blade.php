                                    ...
                                    <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                        <div @class([
                                            ...
                                            @if ($record->leader_avatar)
                                                <img src="{{ $record->leader_avatar }}" alt="User avatar"
                                        ...
                                        <div class="flex flex-col min-w-0">
                                            ...
                                            <span @class([
                                                ...
                                                {{ $record->leader_name }}
                                                @if ($record->is_leader)
                                                    <span class="text-[10px] text-primary-600 font-bold ml-1">(Anda)</span>
                                                @endif
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flex flex-wrap gap-1.5">
                                            @forelse ($record->students as $student)
                                                <span @class([
                                                    ...
                                                    'bg-gray-50 dark:bg-gray-800/50 text-gray-700 dark:text-gray-300 ring-gray-200 dark:ring-gray-700' => !$student->is_me,
