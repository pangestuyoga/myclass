        ...
        <div class="space-y-4">
            ...
            @empty
                <x-filament::empty-state icon="heroicon-o-calendar-days" heading="Tidak ada data yang ditemukan"
                    description="Tidak ada sesi perkuliahan yang dijadwalkan untuk hari ini." iconColor="gray">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @empty
                <div class="col-span-full text-center">
                    <x-filament::empty-state icon="heroicon-o-academic-cap" heading="Mata Kuliah Belum Terdaftar"
                        description="Belum ada mata kuliah yang terdaftar untuk semester aktif ini." iconColor="gray">
                    </x-filament::empty-state>
                </div>
            @endforelse
        </div>
