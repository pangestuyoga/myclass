    ...
    <x-filament::section
        ...
        <div class="flex flex-col sm:flex-row sm:items-start gap-5 relative z-10">
            ...
            <div>
                ...
                <p
                    class="text-sm text-gray-600 dark:text-gray-400 mt-2 max-w-3xl leading-relaxed group-hover:text-gray-900 dark:group-hover:text-gray-300 transition-colors duration-300">
